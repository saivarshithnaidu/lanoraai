...
import { getNextApiKey, incrementKeyUsage, logToDB, logUsage, markKeyAsFailed } from '@/lib/api-pool'
...
export async function POST(req: Request) {
  try {
    ...
    Your tone is ${mode}. ${modePrompts[mode as keyof typeof modePrompts]}
